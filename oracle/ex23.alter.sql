...
alter table tblEdit
    add(description varchar2(100) not null); --not null 컬럼, 데이터가 하나도 없어야지 가능, delete -> 추가, 임시로 default -> 후처리 필요

alter table tblEdit
    add(description varchar2(100) default '임시' not null); -- 나중에 수정해야 돼 
...
alter table tblEdit
    --modify(컬럼 정의)
    modify(data varchar2(9)); --최대 9바이트
