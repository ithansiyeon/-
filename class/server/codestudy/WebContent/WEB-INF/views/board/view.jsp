		...
		<div class="content col-sm-12 col-md-9">
			<div>
                ...
                <div class="btns btn-group">
                    ...
                    <c:if test = "${id == dto.id}">
                    <!-- session id와 글쓴사람 id가 같은지 네가 쓴 글이냐? -->
                ...
                <table class="table comment">
                    ...
                    <tr>
                        <td>
                            ...
                            <span class="update" onclick="location.href='/codestudy/board/updatecomment.do?seq=${cdto.seq}&bseq=${dto.seq}';">[수정]</span>
                            <!-- 부모와 본인 글번호 -->
                            </c:if>
                            <c:if test = "${seq == cdto.mseq}">
