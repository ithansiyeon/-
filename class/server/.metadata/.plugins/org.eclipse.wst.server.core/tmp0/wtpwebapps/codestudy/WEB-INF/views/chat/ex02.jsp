...
<body>
	<div class = "container">
		...
		<!-- 
			...
			2. 자바스크립트 객체 <-> 서버
				a. Ajax(요청이 있어야 서버가 보낼 수 있어) 타이머를 돌려서 클라언트가 요청을 반복해서 해
				b. WebSocket(Java 소켓(네트워크) + 스레드) (지속)
	...
	<script>
		...
		var url = "ws://localhost:8090/codestudy/server"; // 서버
		var ws; // 클라이언트 
