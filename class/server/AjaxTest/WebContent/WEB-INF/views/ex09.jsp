...
<style>
	.container {
		width: 500px;
		position:relative;  /* 자식의 부모역할을 하기 위해서 */
	...
	<script>
		...
		$("#search").keyup(function() {
			...
			if(word.trim().length>0){
				...
				// - 정규식 -> ^[A-Za-z0-9\s _ 가-힣]{1,}$ 
				var regex = /^[A-Za-z0-9\s _ 가-힣]{1,}$/gi;
				//g는 여러번 찾아줘 
			...
			function sel(){
				//$(this) -> jQuery를 사용해서 이벤트를 걸었을 때만 사용 || window(BOM)
