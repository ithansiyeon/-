...
public class New {
	public void ne() throws Exception {
		// 파일 선언
		File file = new File("C:\\Users\\PC\\OneDrive\\바탕 화면\\test\\수강생.txt");
		File file2 = new File("C:\\Users\\PC\\OneDrive\\바탕 화면\\test\\수강생_로그인.txt");
		File file3 = new File("C:\\Users\\PC\\OneDrive\\바탕 화면\\test\\강사.txt");
		File file4 = new File("C:\\Users\\PC\\OneDrive\\바탕 화면\\test\\강사_로그인.txt");
		//버퍼라이터 선언
