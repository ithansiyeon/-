...
public class Admin_Consult_Test {
	...
	public static void main(String args[]) {
		try {
			String path = "C:\\Users\\PC\\OneDrive\\바탕 화면\\프로젝트1\\상담";
			...
			if(!loop) {
				...
				String path1 = "C:\\Users\\PC\\OneDrive\\바탕 화면\\프로젝트1\\상담\\상담.txt";
...
//		}
	...
	private static void dummy() throws Exception {
		...
		File file = new File(path);
		File file1 = new File("C:\\Users\\PC\\OneDrive\\바탕 화면\\프로젝트1\\수강생\\수강생.txt");
