...
public class Member_Consultation_Test {
	private static Member_Consultation_Output output;
	private static Scanner scan;
	private static HashMap<Integer, Consult> map;

	static {
		output = new Member_Consultation_Output();
	...
	private static void search() {
		...
		output.title(Member_Consultation_Title.SEARCH);
	...
	private static void read() throws Exception {
		...
		String path = "C:\\Users\\PC\\OneDrive\\바탕 화면\\프로젝트1\\상담\\상담.txt";
	...
	private static void registration() {
		...
		output.title(Member_Consultation_Title.REGISTRATION);
	...
	private static void list() {
		...
		output.title(Member_Consultation_Title.LIST);
